...
echo "[0] EliasNorth Load Balancer — FINAL DEPLOYMENT using Elias Billing Account"
...
echo "[1] Authenticating as Elias..."
...
echo "[10] Creating Forwarding Rule..."
...
echo "[11] Final IP Address:"
gcloud compute addresses describe $STATIC_IP_NAME \
  --global --format="get(address)"

echo "[DONE] Use the above IP for A record in Namecheap."
