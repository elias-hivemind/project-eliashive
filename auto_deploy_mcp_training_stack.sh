...
echo "🧩 Auto-deploying MCP training stack with voice, monitor, and Hugging Face trainer..."

TARGET_SCRIPT="/opt/mcp-server/mcp_enhance_training_stack.sh"

# Make sure directory exists
mkdir -p /opt/mcp-server

# Create the full training script and auto-run it
cat <<'EOSCRIPT' > "$TARGET_SCRIPT"
#!/bin/bash
